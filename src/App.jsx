...
// Real events with actual addresses for Google Maps
const realEventsData = [
  ...
  },
  {
    ...
    location: 'South Kensington to The O2, Peninsula Square, London SE10 0DX',
  ...
  },
  {
    ...
    location: 'Canary Wharf, 1 Westferry Circus, London E14 4HD',
  ...
  },
  {
    ...
    location: 'Central London to Heathrow Airport, Longford TW6',
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 flex items-center justify-center p-4">
        ...
        <div className="max-w-md w-full relative z-10">
          <div className="text-center mb-8">
            ...
            <h1 className="text-5xl font-bold mb-2 text-white">Welcome to ShareSave</h1>
            <p className="text-xl text-blue-100">Enter your location to discover events near you</p>
          </div>
          
          <form onSubmit={handleSignup} className="bg-white rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-center text-sm text-white mt-4 opacity-90">
        ...
        <div className="flex-1 flex">
          <div className="flex-1">
            <iframe
              ...
              loading="lazy"
              allowFullScreen
              src={`https://www.google.com/maps/embed/v1/search?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=events+near+London&zoom=12`}
            />
          </div>
          
          <div className="w-96 border-l border-gray-200 overflow-y-auto bg-white">
            <div className="p-4">
              <h3 className="font-semibold mb-4 text-lg">Events on Map</h3>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className={`px-2 py-0.5 rounded text-xs font-semibold border inline-block mb-1 ${getCategoryColor(event.category)}`}>
                          {event.category}
                        </div>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 to-purple-700 text-white">
          ...
          <div className="relative max-w-7xl mx-auto px-6 py-20">
            <div className="text-center mb-12">
              <h1 className="text-6xl font-bold mb-4">Share & Save Together</h1>
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                ...
                <button 
                  ...
                  className="px-8 py-4 bg-blue-700 bg-opacity-50 backdrop-blur-sm text-white rounded-lg hover:bg-opacity-70 transition font-semibold flex items-center gap-2 border border-white border-opacity-30"
                >
                  <MapIcon size={20} />
                  View on Map
                </button>
                <button 
                  ...
                  className="px-8 py-4 bg-purple-700 bg-opacity-50 backdrop-blur-sm text-white rounded-lg hover:bg-opacity-70 transition font-semibold flex items-center gap-2 border border-white border-opacity-30"
                >
                  <DollarSign size={20} />
                  Calculate Savings
                </button>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 backdrop-blur-sm">
        <div className="bg-white rounded-2xl p-8 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto shadow-2xl">
          ...
          <div className="flex gap-3 mb-6">
            <a
              href={getGoogleMapsUrl(selectedEvent.address)}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href={getDirectionsUrl(selectedEvent.address)}
              target="_blank"
              rel="noopener noreferrer"
